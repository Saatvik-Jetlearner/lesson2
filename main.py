...
def yellow_handle_movement(keys_pressed, yellow):
    ...
    if keys_pressed[pygame.K_w] and yellow.y - VEL > 0:
        yellow.x -= VEL
    if keys_pressed[pygame.K_d] and yellow.y + VEL + yellow.height < HEIGHT:
        yellow.x += VEL
def red_handle_movement(keys_pressed, red):
    if keys_pressed[pygame.K_RIGHT] and red.x - VEL > 0:
        red.x += VEL
    if keys_pressed[pygame.K_LEFT] and red.x + VEL + red.width < WIDTH:
        red.x -= VEL
